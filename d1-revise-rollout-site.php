...
// Add Entry Code
if(isset($_GET['revisedone'])){ 
$d1Edited_sts=2; 
$editdsiteid=($_GET['d1siteid']);

$query=mysqli_query($con,"update `d1_site_list` set `d1Edited_status`= '$d1Edited_sts' where id='$editdsiteid';");

echo "<script>alert('D1 Revise record updated.');</script>";   
echo "<script>window.location.href='d1-revise-rollout-site.php'</script>";
}
...
<head>
    ...
    <title>D1 revise Site List - Rollout Master</title>
        ...
        <div class="hk-pg-wrapper">
           ...
           <nav class="hk-breadcrumb" aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-dark black bg-dark" style="border: 1px solid #F00A7C">
					<li class="breadcrumb-item"><a href="#"><i class="fa fa-home"></i>&nbsp;D1 Site List (Need to revise)</a></li>
...
<div class="col-lg-12">
						...
						<!--<div class="table-wrap">  <!--table-wrap-->
							...
							<div class="Panel panel-heading" style="position:relative; margin-left:1.5%;margin-top:1%;"><b><i class="fa fa-list-ul"></i>&nbsp;D1 Site detail to Revise.</b></div>	
...
?>								
									<tr class="tr-hover-class">						
											...
											<a href="d1-revise-rollout-site.php?d1siteid=<?php echo htmlentities($user['id']);?>&revisedone=d1sitedone" data-toggle="tooltip" data-original-title="Click to Done the Site's information" onclick="return confirm('Do you really want to Done it?.');" type="button" class="btn btn-success btn-rounded" style="text-align:center;font-size:9px;">Done</a>					
											</td>
