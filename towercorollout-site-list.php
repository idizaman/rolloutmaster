...
<head>
    ...
    <title>Rollout Site List - Rollout Master</title>
        ...
        <div class="hk-pg-wrapper">
           ...
           <nav class="hk-breadcrumb" aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-dark black bg-dark" style="border: 1px solid #F00A7C">
					<li class="breadcrumb-item"><a href="#"><i class="fa fa-home"></i>&nbsp;Rollout Site List</a></li>
...
<div class="col-sm-12">
						...
						<div class="table-wrap">  <!--table-wrap-->
							...
							<div class="Panel panel-heading" style="position:relative; margin-left:1.5%;margin-top:1%;"><b><i class="fa fa-list-ul"></i>&nbsp;Rollout Site Details.</b></div>	
...
?>
									...
									<table id="datable_11lm" class="display nowrap cell-border compact table table-bordered" style="width:100%; display:none;">
